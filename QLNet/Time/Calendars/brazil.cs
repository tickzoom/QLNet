...
namespace QLNet
{
  ...
  private static Calendar.Impl  settlementImpl = new Brazil.SettlementImpl();
        private static Calendar.Impl  exchangeImpl = new Brazil.ExchangeImpl();
        //! Brazilian calendars
