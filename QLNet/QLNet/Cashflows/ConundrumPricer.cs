...
//               the pay date  
		...
		private class GFunctionWithShifts : GFunction
		{
			...
			private class ObjectiveFunction : ISolver1d
			{
                ...
                public override double derivative(double UnnamedParameter1)
				{
					return derivative_;
				}
				...
				public GFunctionWithShifts gFunctionWithShifts()
				{
					return o_;
				}
			}
...
//    
	...
	//                             HaganPricer                               //
	//===========================================================================//
		protected HaganPricer(Handle<SwaptionVolatilityStructure> swaptionVol, GFunctionFactory.YieldCurveModel modelOfYieldCurve, Handle<Quote> meanReversion) : base(swaptionVol)
		{
...
//    
	...
	{
		public NumericHaganPricer(Handle<SwaptionVolatilityStructure> swaptionVol, GFunctionFactory.YieldCurveModel modelOfYieldCurve, Handle<Quote> meanReversion, double lowerLimit, double upperLimit, double precision) : base(swaptionVol, modelOfYieldCurve, meanReversion)
		{
	  ...
	  //private:
        ...
        {
            public VariableChange(ref Func<double, double> f, double a, double b, int k)
            {
                a_ = a;
                b_ = b;
                width_ = b - a;
		...
		public class ConundrumIntegrand : Function
		{
...
// TODO                 f = boost.bind(variableChange.value, variableChange, _1);
                        ...
                        result = gaussKronrodNonAdaptive.value(f, .0, 1.0);
                    }
                    else
                    {
                        f = integrand.value;
                        result = gaussKronrodNonAdaptive.value(f, a, upperBoundary);
                    }
