...
namespace QLNet
{
    ...
    */
    public class India : Calendar {
      private class NseImpl : Calendar.WesternImpl {
        ...
        private static Calendar.Impl impl = new India.NseImpl();
      public enum Market { NSE    //!< National Stock Exchange
        };
        India(){
         new India(Market.NSE);
        }
