...
namespace ABSLibrary
{
    class Error
    {
		...
		public static ArgumentException UnkownMarket(Market m) {
			return new ArgumentException("Unknown market: " + m); }
		...
		public static ArgumentException UnkownDayCountConvention(Convention c) {
			return new ArgumentException("Unknown day count convention: " + c); }
		public static ArgumentException UnknownThirty360Convention(Thirty360Convention c) {
			return new ArgumentException("Unknown 30/360 convention: " + c); }
