...
//    
	public class DailyTenorEURLibor : IborIndex
	{
		...
		public DailyTenorEURLibor(int settlementDays) : this(settlementDays, new Handle<YieldTermStructure>())
		{
		}
	...
	{
		public EURLiborON() : base(0, new Handle<YieldTermStructure>())
		{
		}

		public EURLiborON(Handle<YieldTermStructure> h) : base(0, h)
		{
		}
	}
	...
	{
		public EURLiborSW() : base(new Period(1, TimeUnit.Weeks), new Handle<YieldTermStructure>())
		{
		}
		public EURLiborSW(Handle<YieldTermStructure> h) : base(new Period(1, TimeUnit.Weeks), h)
		{
		}
	}
	...
	{
		public EURLibor2W() : base(new Period(2, TimeUnit.Weeks), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor2W(Handle<YieldTermStructure> h) : base(new Period(2, TimeUnit.Weeks), h)
		{
		}
	}
	...
	{
		public EURLibor1M() : base(new Period(1, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor1M(Handle<YieldTermStructure> h) : base(new Period(1, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor2M() : base(new Period(2, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor2M(Handle<YieldTermStructure> h) : base(new Period(2, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor3M() : base(new Period(3, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor3M(Handle<YieldTermStructure> h) : base(new Period(3, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor4M() : base(new Period(4, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor4M(Handle<YieldTermStructure> h) : base(new Period(4, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor5M() : base(new Period(5, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor5M(Handle<YieldTermStructure> h) : base(new Period(5, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor6M() : base(new Period(6, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor6M(Handle<YieldTermStructure> h) : base(new Period(6, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor7M() : base(new Period(7, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor7M(Handle<YieldTermStructure> h) : base(new Period(7, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor8M() : base(new Period(8, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor8M(Handle<YieldTermStructure> h) : base(new Period(8, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor9M() : base(new Period(9, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor9M(Handle<YieldTermStructure> h) : base(new Period(9, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor10M() : base(new Period(10, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor10M(Handle<YieldTermStructure> h) : base(new Period(10, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor11M() : base(new Period(11, TimeUnit.Months), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor11M(Handle<YieldTermStructure> h) : base(new Period(11, TimeUnit.Months), h)
		{
		}
	}
	...
	{
		public EURLibor1Y() : base(new Period(1, TimeUnit.Years), new Handle<YieldTermStructure>())
		{
		}
		public EURLibor1Y(Handle<YieldTermStructure> h) : base(new Period(1, TimeUnit.Years), h)
		{
		}
	}
