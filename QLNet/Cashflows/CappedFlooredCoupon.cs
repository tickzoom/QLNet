...
namespace QLNet {
    ...
    public class CappedFlooredIborCoupon : CappedFlooredCoupon {
        ...
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart, Date refPeriodEnd, DayCounter dayCounter)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, refPeriodEnd, dayCounter, false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart, Date refPeriodEnd)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, refPeriodEnd, new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, new Date(), new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread, double? cap, double? floor)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread, double? cap)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, null, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing, double spread)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, null, null, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index, double gearing)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, 0.0, null, null, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredIborCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, IborIndex index)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, 1.0, 0.0, null, null, new Date(), new Date(), new DayCounter(), false) {
        }
    ...
    public class CappedFlooredCmsCoupon : CappedFlooredCoupon {
        ...
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart, Date refPeriodEnd, DayCounter dayCounter)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, refPeriodEnd, dayCounter, false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart, Date refPeriodEnd)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, refPeriodEnd, new DayCounter(), false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread, double? cap, double? floor, Date refPeriodStart)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, refPeriodStart, new Date(), new DayCounter(), false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread, double? cap, double? floor)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, floor, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread, double? cap)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, cap, null, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing, double spread)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, spread, null, null, new Date(), new Date(), new DayCounter(), false) {
        }
        public CappedFlooredCmsCoupon(double nominal, Date paymentDate, Date startDate, Date endDate, int fixingDays, SwapIndex index, double gearing)
            : this(nominal, paymentDate, startDate, endDate, fixingDays, index, gearing, 0.0, null, null, new Date(), new Date(), new DayCounter(), false) {
        }
