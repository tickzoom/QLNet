...
namespace QLNet {
	...
	public class DigitalCmsCoupon : DigitalCoupon
	{
		...
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff, double? putStrike, Position.Type putPosition, bool isPutATMIncluded, double? putDigitalPayoff) : this(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, putStrike, putPosition, isPutATMIncluded, putDigitalPayoff, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff, double? putStrike, Position.Type putPosition, bool isPutATMIncluded) : this(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, putStrike, putPosition, isPutATMIncluded, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff, double? putStrike, Position.Type putPosition) : this(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, putStrike, putPosition, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff, double? putStrike) : this(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, putStrike, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff) : this(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, null, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded) : this(underlying, callStrike, callPosition, isCallATMIncluded, null, null, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition) : this(underlying, callStrike, callPosition, false, null, null, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike) : this(underlying, callStrike, Position.Type.Long, false, null, null, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying) : this(underlying, null, Position.Type.Long, false, null, null, Position.Type.Long, false, null, new DigitalReplication())
		{
		}
		public DigitalCmsCoupon(CmsCoupon underlying, double? callStrike, Position.Type callPosition, bool isCallATMIncluded, double? callDigitalPayoff, double? putStrike, Position.Type putPosition, bool isPutATMIncluded, double? putDigitalPayoff, DigitalReplication replication) : base(underlying, callStrike, callPosition, isCallATMIncluded, callDigitalPayoff, putStrike, putPosition, isPutATMIncluded, putDigitalPayoff, replication)
		{
		}
